            ...
            <div id="container">
                ...
                <form class="layui-form" action="../server/server_questionadd.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-inline">
                            <textarea name="right_key" placeholder="请输入内容" class="layui-textarea" style="width:500px"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item layui-form-text">
                        <label class="layui-form-label">选项1</label>
                        <div class="layui-input-inline">
                            <textarea name="answer_a" placeholder="请输入内容" class="layui-textarea" style="width:500px"></textarea>
                        </div>

                        <label class="layui-form-label">选项2</label>
                        <div class="layui-input-inline">
                            <textarea name="answer_b" placeholder="请输入内容" class="layui-textarea" style="width:500px"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item layui-form-text">
                        <label class="layui-form-label">选项3</label>
                        <div class="layui-input-inline">
                            <textarea name="answer_c" placeholder="请输入内容" class="layui-textarea" style="width:500px"></textarea>
                        </div>
                        <label class="layui-form-label">选项4</label>
                        <div class="layui-input-inline">
                            <textarea name="answer_d" placeholder="请输入内容" class="layui-textarea" style="width:500px"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="open" value="0" title="私有" value="自己的" checked>
                            <input type="radio" name="open" value="1" title="公有" value="公共的">
                        </div>
                    </div>
